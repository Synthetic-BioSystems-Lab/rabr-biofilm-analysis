...
df_23s = pd.read_csv("23s_data.csv")

# Filter Data (RABR and Phylum) and exclude same RABR at different time
df_23s = df_23s[
    (df_23s["section"] == "81RABR")
    & (df_23s["level"] == "Phylum")
    & (~df_23s["sample_id"].isin(["R45_11_15_21", "R60_11_15_22"]))
].copy()

print(df_23s)

# Write csv
df_23s.to_csv("23s_data_81RABR.csv", index=False)

# Filter temperature and exclude abundunce less than 1%
df_10 = df_23s[df_23s["temp[C]"] == 10.0].copy()
df_10 = df_10[df_10["rel_abund"] >= 1].copy()

df_20 = df_23s[df_23s["temp[C]"] == 20.0].copy()
df_20 = df_20[df_20["rel_abund"] >= 1].copy()

df_30 = df_23s[df_23s["temp[C]"] == 30.0].copy()
...
label_order_10 = ["R60_11_01_21", "R43_11_15_21", "R72_11_15_21", "R75_11_15_21"]

label_order_20 = ["R45_10_18_21", "R36_10_28_21", "R58_10_28_21", "R46_11_05_21"]

labels = label_order_10
...
# Formatting
ax.set_title(
    "Relative Abundance of 23S Phototrophic Taxa by Sample (10°C)", fontsize=14
)
...
plt.tight_layout()
plt.savefig("23S_Lab_10.pdf", format="pdf", bbox_inches="tight")
plt.show()
