...
combined_df = combined_df[
    (combined_df["section"] == "pilot")
    & (combined_df["level"] == "Phylum")
    & (
        ~combined_df["sample_id"].isin(
            ["P_11_02_23_S2", "P_10_12_23_S2", "P_10_12_23_S3"]
        )
    )
].copy()
...
# Write csv
combined_df.to_csv("16s_data_pilot.csv", index=False)
...
label_order = ["P_10_05_23", "P_10_12_23", "P_10_19_23", "P_10_26_23", "P_11_02_23"]
...
# colors2 = plt.get_cmap("Set1").colors
# colors3 = plt.get_cmap("Set3").colors
# colors = sns.color_palette("husl", n_colors=26)  # HUSL = evenly spaced hues

# Combine three qualitative palettes
colors = (
...
ax.set_title(
    "Relative Abundance of 16S Bacterial Taxa by Sample (Mothur vs. DADA2)", fontsize=14
)
...
plt.tight_layout()
plt.savefig("16S_pilot.pdf", format="pdf", bbox_inches="tight")
plt.show()
