...
df_18s = df_18s[
    (df_18s["section"] == "pilot")
    & (df_18s["level"] == "Phylum")
    & (~df_18s["sample_id"].isin(["P_11_02_23_S2", "P_10_12_23_S2", "P_10_12_23_S3"]))
].copy()

print(df_18s)

# Write csv
df_18s.to_csv("18s_data_pilot.csv", index=False)
...
# Colors: Combine three qualitative palettes
colors = (
...
plt.tight_layout()
plt.savefig("18S_pilot.pdf", format="pdf", bbox_inches="tight")
plt.show()
