...
create_directory("./A23SFastq") 
create_directory("./A23SFastq/23SF") 
create_directory("./A23SFastq/23SR") 
create_directory("./A23SFastq/23SF/filtered") 
create_directory("./A23SFastq/23SR/filtered") 
path <- "./A23SFastq" 
forward_data_path <- "./A23SFastq/23SF" 
reverse_data_path <- "./A23SFastq/23SR" 
...
forward_data_path_filtered_23S <- "./A23SFastq/23SF/filtered" #forward_data_path_filtered_23S has now been changed to the "filtered" directory 
...
create_directory("./A23SFastq/results") 
saveRDS(seqtabE, "./A23SFastq/results/seqtabE.rds")



# Merge Runs, Remove Chimeras, Assign Taxonomy # 
pathRDS <- "./A23SFastq/results/seqtabE.rds" # Where the RDS files were saved 
#Remove chimeras 
...
saveRDS(seqtabE, "./A23SFastq/results/seqtabE.rds") # This is where the sequencing table file is saved 
saveRDS(taxE, "./A23SFastq/results/taxE.rds") # This is where the taxonomy file is saved 
...
ggsave("A23SFastq/results/23SDADA2_23S_stacked_bar.tiff", 
       width=9, height=4) 
